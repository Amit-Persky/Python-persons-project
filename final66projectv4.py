...
def menu():
    while True:
        printMenu()
        try:
            choice = input("Please enter your choice (1-" + str(len(MenuOption)) + "): ")
            if choice.isdigit and 1 <= int(choice) <= len(MenuOption):
                ...
                print("Invalid input: Please enter a number between 1-" + str(len(MenuOption)) + ".")
        except ValueError:
